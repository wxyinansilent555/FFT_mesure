...
#define ADC1_DR_Address    ((u32)0x4001244C) //adc1的起始地址是40012400 ，偏移是4c
u16 DMA1_MEM_LEN;
//保存DMA每次数据传送的长度
//DMA1的各通道配置
...
void MYDMA_Config(void)
{
	...
	RCC_AHBPeriphClockCmd(RCC_AHBPeriph_DMA1, ENABLE );
  	...
  	DMA_InitStruct.DMA_PeripheralBaseAddr = (u32)&ADC1->DR;	//DMA对应的外设基地址，使用对象类结构体访问
  	DMA_InitStruct.DMA_PeripheralDataSize = DMA_PeripheralDataSize_HalfWord; //转换结果16bits，半字
